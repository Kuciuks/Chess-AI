...
function initiateAI(chess_board,enemy){
    console.log('[AI INITIATED]', enemy,configInstance.depth)
    //acivate minimax and capture returned values

    let [best_move, best_score, original_index] = minimax(configInstance.depth, chess_board, enemy, -Infinity, Infinity, configInstance.active_board)
