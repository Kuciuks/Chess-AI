...
function initiateAI(chess_board){
    console.log('[AI INITIATED]',configInstance.enemy)
    //acivate minimax and capture returned values
    let [best_move, best_score, original_index] = minimax(configInstance.depth, chess_board, configInstance.enemy, -Infinity, Infinity)
